    ...
    <div style={cardStyle}>
      ...
      <div style={formGridStyle}>
        <input
          ...
          onChange={(e) => updateOpening({ name: e.target.value })}
        />
        <select
          value={newOpening.category}
          onChange={(e) => updateOpening({ category: e.target.value as "Door" | "Window" })}
        >
        ...
        <input
          ...
          onChange={(e) => updateOpening({ widthMm: Number(e.target.value) })}
        />
        <input
          type="number"
          placeholder="Height (mm)"
          value={newOpening.heightMm}
          onChange={(e) => updateOpening({ heightMm: Number(e.target.value) })}
        />
        <input
          type="number"
          placeholder="Default Quantity"
          value={newOpening.quantity}
          onChange={(e) => updateOpening({ quantity: Number(e.target.value) })}
        />

        <select
          value={newOpening.wallThicknessOption}
          onChange={(e) => updateOpening({ wallThicknessOption: e.target.value as WallThicknessOption })}
        >
        ...
        {newOpening.wallThicknessOption === "Other mm" && (
          <input
            ...
            value={newOpening.wallThicknessMm || 0}
            onChange={(e) => updateOpening({ wallThicknessMm: Number(e.target.value) })}
          />
        )}
        ...
        <label>
          <input
            type="checkbox"
            checked={newOpening.includeLintel}
            onChange={(e) => updateOpening({ includeLintel: e.target.checked })}
          />
          Include Lintel
        </label>
        {newOpening.includeLintel && (
          <input
            type="number"
            placeholder="Lintel bearing (mm)"
            value={newOpening.lintelBearingMm}
            onChange={(e) => updateOpening({ lintelBearingMm: Number(e.target.value) })}
          />
        )}
        <label>
          <input
            type="checkbox"
            checked={newOpening.includeRevealPlaster}
            onChange={(e) => updateOpening({ includeRevealPlaster: e.target.checked })}
          />
          Include Reveal Plaster
        </label>
        ...
        {category === "Door" && (
          <>
            <select
              value={newOpening.doorConfiguration || "Single"}
              onChange={(e) => updateOpening({ doorConfiguration: e.target.value as DoorConfiguration })}
            >
            ...
            <select
              value={newOpening.doorLeafType || "Hollow core timber door"}
              onChange={(e) => updateOpening({ doorLeafType: e.target.value as DoorLeafType })}
            >
            ...
            <select
              value={newOpening.doorFrameType || "Timber frame"}
              onChange={(e) => updateOpening({ doorFrameType: e.target.value as DoorFrameType })}
            >
            ...
            <label>
              <input
                type="checkbox"
                checked={newOpening.paintDoor || false}
                onChange={(e) => updateOpening({ paintDoor: e.target.checked })}
              />
              Paint door
            </label>
            <label>
              <input
                type="checkbox"
                checked={newOpening.paintFrame || false}
                onChange={(e) => updateOpening({ paintFrame: e.target.checked })}
              />
              Paint frame
            </label>
            <label>
              <input
                type="checkbox"
                checked={newOpening.includeIronmongery || false}
                onChange={(e) => updateOpening({ includeIronmongery: e.target.checked })}
              />
              Include ironmongery
            </label>
            <label>
              <input
                type="checkbox"
                checked={newOpening.includeThreshold || false}
                onChange={(e) => updateOpening({ includeThreshold: e.target.checked })}
              />
              Include threshold
            </label>
          </>
        ...
        {category === "Window" && (
          <>
            <select
              value={newOpening.windowType || "Aluminium window"}
              onChange={(e) => updateOpening({ windowType: e.target.value as WindowType })}
            >
            ...
            <select
              value={newOpening.windowFrameType || "Aluminium"}
              onChange={(e) => updateOpening({ windowFrameType: e.target.value as WindowFrameType })}
            >
            ...
            <label>
              <input
                type="checkbox"
                checked={newOpening.externalSill || false}
                onChange={(e) => updateOpening({ externalSill: e.target.checked })}
              />
              External sill
            </label>
            <label>
              <input
                type="checkbox"
                checked={newOpening.internalSill || false}
                onChange={(e) => updateOpening({ internalSill: e.target.checked })}
              />
              Internal sill
            </label>
            <label>
      ...
      <table style={tableStyle} border={1} cellPadding={8}>
        <thead>
          <tr>
            ...
            <th style={thStyle}>Height (mm)</th>
            <th style={thStyle}>Qty</th>
            <th style={thStyle}>Lintel</th>
      ...
      <div style={formGridStyle}>
        <input
          placeholder="Mark"
          value={newOpeningMeas.mark}
          onChange={(e) => updateOpeningMeas({ mark: e.target.value })}
        />
        <select
          value={newOpeningMeas.openingTypeId}
          onChange={(e) => updateOpeningMeas({ openingTypeId: Number(e.target.value) })}
        >
        ...
        <input
          ...
          value={newOpeningMeas.quantity}
          onChange={(e) => updateOpeningMeas({ quantity: Number(e.target.value) })}
        />
        <button onClick={addOpeningMeasurement}>Add</button>
      </div>
      ...
      <table style={tableStyle} border={1} cellPadding={8}>
        <thead>
          <tr>
            ...
            <th style={thStyle}>Opening Type</th>
            <th style={thStyle}>Quantity</th>
            <th style={thStyle}>Wall ID (future)</th>
          </tr>
        </thead>
        <tbody>
